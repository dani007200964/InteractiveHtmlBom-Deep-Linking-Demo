...
Because html rules there are some specia characters, like `+` or `-` symbols and so on. For this reason some URL woodoo is needed to 'escape' these characters. For this reason a copy link button added next to each net and component name, that makes things simple.
